...
**SIFT-Based Object Detection in Video**

> Student: Narubet Intaraprasit | 6710422003 | Section 01
...
|---|----------|--------|--------|-------|----------|
| 1 | ![](case_success/easy/assets/template_1.png) | [run_easy_1.py](case_success/easy/run_easy_1.py) | MIN=10, ratio=0.75, RANSAC=5.0 | [![video](https://img.shields.io/badge/▶-Google%20Drive-blue)](YOUR_DRIVE_LINK_EASY_1) | [ANALYSIS_easy_1.txt](case_success/easy/ANALYSIS_easy_1.txt) |
| 2 | ![](case_success/easy/assets/template_2.png) | [run_easy_2.py](case_success/easy/run_easy_2.py) | MIN=10, ratio=0.75, RANSAC=5.0 | [![video](https://img.shields.io/badge/▶-Google%20Drive-blue)](YOUR_DRIVE_LINK_EASY_2) | [ANALYSIS_easy_2.txt](case_success/easy/ANALYSIS_easy_2.txt) |
| 3 | ![](case_success/easy/assets/template_3.png) | [run_easy_3.py](case_success/easy/run_easy_3.py) | MIN=10, ratio=0.75, RANSAC=5.0 | [![video](https://img.shields.io/badge/▶-Google%20Drive-blue)](YOUR_DRIVE_LINK_EASY_3) | [ANALYSIS_easy_3.txt](case_success/easy/ANALYSIS_easy_3.txt) |
| 4 | ![](case_success/easy/assets/template_4.png) | [run_easy_4.py](case_success/easy/run_easy_4.py) | MIN=10, ratio=0.75, RANSAC=5.0 | [![video](https://img.shields.io/badge/▶-Google%20Drive-blue)](YOUR_DRIVE_LINK_EASY_4) | [ANALYSIS_easy_4.txt](case_success/easy/ANALYSIS_easy_4.txt) |
| 5 | ![](case_success/easy/assets/template_5.png) | [run_easy_5.py](case_success/easy/run_easy_5.py) | MIN=10, ratio=0.75, RANSAC=5.0 | [![video](https://img.shields.io/badge/▶-Google%20Drive-blue)](YOUR_DRIVE_LINK_EASY_5) | [ANALYSIS_easy_5.txt](case_success/easy/ANALYSIS_easy_5.txt) |
...
## Multi-Detect Bonus Case

> Detect **multiple instances** of the same object in one frame using Iterative Homography.

| Case | Template | Object | Max Detect | Script | Video | Note |
|------|----------|--------|-----------|--------|-------|------|
| Multi-Difficult | ![](cases_multi_difficult/assets/template_3.png) | Ferris wheel gondola | 7 | [run_multi_detect_difficult.py](run_multi_detect_difficult.py) | [![video](https://img.shields.io/badge/▶-Google%20Drive-blue)](YOUR_DRIVE_LINK_MULTI) | MIN=8, ratio=0.75, RANSAC=8.0 |

**How Iterative Homography works:**

```
1. Run standard SIFT → FLANN → Ratio Test → RANSAC → detect 1st instance
2. Remove inlier keypoints from descriptor pool
3. Repeat on remaining descriptors → detect 2nd instance
4. Continue until MAX_DETECTIONS or < MIN_MATCH matches remain
```
...
# Run any case
python case_success/easy/run_easy_1.py
python case_success/difficult/run_difficult_2.py
python case_failed/failed_as_expected/run_failed_expected_1.py
python case_failed/failed_but_unexpected/run_failed_unexpected_1.py
python run_multi_detect_difficult.py
```

Output videos are saved in each case's `output/` folder.

---

## Video Links (Google Drive)

> Replace `YOUR_DRIVE_LINK_*` placeholders in the tables above with actual Drive shareable links.
...
*CI 7204 Image Processing and Analytics — 2/2568 — Narubet Intaraprasit*

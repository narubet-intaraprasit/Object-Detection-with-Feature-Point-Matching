...
## Challenge 2 — SUCCESS / EASY  #3
## ============================================================
## Target Object  : <FILL IN>  e.g. "Movie poster"
## Template Source: <FILL IN>
## Video Source   : <FILL IN>
## Why easy       : High detail poster, stable camera, good lighting
## ============================================================
...
config = {
    ...
    "OUTPUT_PATH":   os.path.join(BASE, "output", "output_easy_3.mp4"),
    ...
    "DESCRIPTION": "Easy case: movie/music poster with many distinctive features",
}

...
## Challenge 2 — SUCCESS / EASY  #4
## ============================================================
## Target Object  : <FILL IN>  e.g. "Board game box / playing card"
## Template Source: <FILL IN>
## Video Source   : <FILL IN>
## Why easy       : Unique card design, flat object, stable framing
## ============================================================
...
config = {
    ...
    "OUTPUT_PATH":   os.path.join(BASE, "output", "output_easy_4.mp4"),
    ...
    "DESCRIPTION": "Easy case: flat printed object with unique graphics",
}
